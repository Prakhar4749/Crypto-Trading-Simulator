...
public class EmailTemplateBuilder {
  ...
  private static String buildLogo(
    ...
    return ""; // No logo if URL not set
  }

  // ═══ GREETING ═══
  public static String greeting(
      String fullName) {
    return "<h2 style='color:#1a1a2e;" +
  ...
  public static String warningBox(
      String text) {
    return "<div style='background:#fff3cd;" +
      "border:1px solid #ffc107;" +
      "border-radius:8px;padding:12px 16px;" +
      "margin:16px 0;color:#856404;" +
      "font-size:13px;'>" +
      "⚠️ " + text + "</div>";
  }
  ...
  public static String footer(
    ...
    <p style="margin:8px 0;">
      <a href="%s" style="color:#ffd700;
        text-decoration:none;
        font-size:12px;">
        Visit CoinDesk Platform
      </a>
    </p>
