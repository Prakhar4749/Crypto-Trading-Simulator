package com.prakhar.marketai.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBaseException(BaseException ex, HttpServletRequest request) {
        log.error(LogUtil.error("market-ai-service", request.getRequestURI(), request.getHeader("X-User-Id"), "[" + ex.getErrorCode() + "] " + ex.getMessage()), ex.getStatus().is5xxServerError() ? ex : null);
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        log.warn(LogUtil.warn("market-ai-service", request.getRequestURI(), request.getHeader("X-User-Id"), "Validation failed: " + details));
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneric(Exception ex, HttpServletRequest request) {
        log.error(LogUtil.error("market-ai-service", request.getRequestURI(), request.getHeader("X-User-Id"), "Unexpected error: " + ex.getMessage()), ex);
